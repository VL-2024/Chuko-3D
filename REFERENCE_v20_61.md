# Что перенесено из ЧҮКӨ v20.61 в Modern 3D v0.4
...
- точка падения меняется от направления и силы;
- небольшое отклонение реального броска от выбранного направления;
- САКА не нацеливается на пустую часть поля: допустимая зона сейчас привязана к кучке.

## Отличие реализации

В v20.61 видимая верхняя дуга САКА рисуется отдельно от 2D Matter.js contact point. В Modern 3D v0.4 пунктир и сама САКА используют одну и ту же баллистическую формулу, а дальнейшее столкновение и разлёт рассчитывает Havok.
