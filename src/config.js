window.CHUKO3D_CONFIG = Object.freeze({
  ...
  game: {
    ...
    scatterInsideMetricMax: 0.84,
    scatterInsideEdgeMetricMin: 0.80,
    scatterInsideEdgeMetricMax: 0.88,
    scatterOutsideMetricMin: 1.90,
    scatterOutsideMetricMax: 2.18,
    scatterMinSeparationWorld: 0.72,
    scatterOutsideFanStepRad: 0.72,
    scatterOutsideFanJitterRad: 0.04,
    ...
    sakaDeterministicContactRadius: 0.14,
